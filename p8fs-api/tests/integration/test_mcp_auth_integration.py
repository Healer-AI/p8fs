...
async def test_complete_mcp_auth_flow_example(client, jwt_token):
    ...
    print("\n🚀 MCP Authentication Flow Example\n")
    
    # Step 1: Use pre-generated JWT token
    print("1️⃣ Using JWT token from ~/.p8fs/auth/token.json...")
    ...
    print(f"   ✅ About P8FS: {about_content[:80]}...")
    
    # Step 4: Get user info
    print("\n4️⃣ Getting authenticated user info...")
    user_info_request = {
        "jsonrpc": "2.0",
        "id": 3,
        "method": "tools/call",
    ...
    print("\n✨ MCP Authentication Flow Complete!\n")
